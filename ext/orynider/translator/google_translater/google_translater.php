 ...
 * orynider\translator\google_translater 
 *
 *
 ...
 *
 */
namespace orynider\translator\google_translater;
if (!defined('IN_PHPBB'))
{
	exit;
}
class google_translater 
{
	...
	* Constructor
	*/
	public function __construct(\phpbb\language\language $lang, \phpbb\request\request $request)
	{
